...
Kitty Gummies is a free and open-sourced Bootstrap themed Angular 9 starter project.
...
Kitty Gummies comes with a base implementation of navigation and layouts.
...
```bash
git clone git@github.com/mpsaba/kittygummies.git
cd sb-admin-angular
npm install
npm start
```
...
Kitty Gummies come with a production ready Dockerfile and build scripts.
